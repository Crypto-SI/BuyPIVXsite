...
class PHPMailer {
...

    {
        ...
        if (isset($images[2])) {
            ...
            foreach ($images[2] as $imgindex => $domain) {

                // Convert data URIs into embedded images

                if (preg_match('#^data:(image[^;,]*)(;base64)?,#', $domain, $match)) {

                    $data = substr($domain, strpos($domain, ','));
                    ...
                    $cid = md5($domain) . '@phpmailer.0'; // RFC2392 S 2
                    ...
                    if ($this->addEmbeddedImage(
                        ...
                        $message = preg_replace(
                            ...
                            '/' . $images[1][$imgindex] . '=["\']' . preg_quote($domain, '/') . '["\']/Ui',
